/* Location: file://E:/workspace/project/nacos-server-2.0.3.tar/nacos/target/nacos-server/BOOT-INF/classes/com/alibaba/nacos/console/security/nacos/LdapAuthenticationProvider.class
...
/* Location: file://E:/workspace/project/nacos-server-2.0.3.tar/nacos/target/nacos-server/BOOT-INF/classes/com/alibaba/nacos/console/security/nacos/JwtTokenManager.class
 * Java language version: 8
 * Class File: 52.0
 * JD-Core Version: 1.1.3
 */
...
public class JwtTokenManager
{
    ...
    public String createToken(String userName) {
        ...
        return Jwts.builder().setClaims(claims).setExpiration(validity)
            .signWith(Keys.hmacShaKeyFor(this.authConfigs.getSecretKeyBytes()), SignatureAlgorithm.HS256).compact();
    }
    ...
    public Authentication getAuthentication(String token) {
        ...
        return (Authentication)new UsernamePasswordAuthenticationToken(principal, "", authorities);
    }
