...
@EnableConfigurationProperties(com.alibaba.cloud.sentinel.gateway.zuul.SentinelZuulProperties.class)
public class SentinelZuulAutoConfiguration {
	...
	@Bean
	public com.alibaba.cloud.sentinel.gateway.zuul.FallBackProviderHandler fallBackProviderHandler(
